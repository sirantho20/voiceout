...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function create()
    {
        ...
        if ($this->save()) {
            (new Mailer())->sendWelcomeMessage($this);
    ...
    {
        if ($this->module->confirmable) {
            (new Mailer())->sendConfirmationMessage($this);
    ...
    public function updateEmail()
    {
        if ($this->validate()) {
            if ($this->module->confirmable) {
                ...
                $this->save(false);
                (new Mailer())->sendReconfirmationMessage($this);
    ...
    public function sendRecoveryMessage()
    {
        ...
        $this->save(false);
        return (new Mailer())->sendRecoveryMessage($this);
