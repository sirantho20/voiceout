...
?>
				...
				<div class="inbox-nav-bar no-content-padding">
					...
					<div class="btn-group hidden-desktop visible-tablet">
						...
						<ul class="dropdown-menu pull-left inbox-menu">
							<li>
				...
				<div id="inbox-content" class="inbox-body no-content-padding">
					...
					<div class="inbox-side-bar">
						...
						<h6> Folders <a href="javascript:void(0);" rel="tooltip" title="" data-placement="right" data-original-title="Refresh" class="pull-right txt-color-darken refresh-btn"><i class="fa fa-refresh"></i></a></h6>
...
Yii::$app->controller->view->registerJs('// DO NOT REMOVE : GLOBAL FUNCTIONS!
	pageSetUp();
	...
	loadInbox();
	function loadInbox() {
		loadURL("/complaint/list", $(\'#inbox-content > .table-wrap\'))
	}
